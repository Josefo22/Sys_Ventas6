...
<!-- Estilos personalizados para el formulario de proveedores -->
<style>
    .page-header {
...
<div class="card animated-row">
    <div class="card-header">
        <h5><i class="fas fa-plus-circle"></i> Ingrese los datos del proveedor</h5>
    </div>
    <div class="card-body">
        <form action="<?php echo BASE_URL; ?>Proveedor/store" method="POST" id="formProveedor">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="telefono" name="telefono" placeholder="Ingrese el teléfono de contacto">
                        </div>
                    </div>
                    <div class="col-md-6 mb-4">
                        <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        $('#formProveedor').submit(function(e) {
            ...
            Swal.fire({
                title: 'Guardando...',
                html: 'Procesando datos del proveedor',
